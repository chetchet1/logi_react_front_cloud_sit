...
function DeptInfo(props) {
  ...
  const DeptColDefs = [
    ...
    { headerName: '부서명', field: 'deptName', flex: 1, editable: true },
    {
      headerName: '부서신설일',
      field: 'deptStartDate',
      flex: 1,
    ...
    { headerName: 'companyCode', field: 'companyCode', flex: 1, hide: true }
  ];
  //=====================================================================================
  useEffect(() => {}, [dispatch]);
  const handleOpen = () => {
  ...
  const handleClick = async (e) => {
    ...
    try {
      await axios
        .get(`${process.env.REACT_APP_DOCKER_API_URL}/compinfo/codedetail/list`, {
          params: {
  ...
  const searchClick = async (e) => {
    console.log('searchClick 함수 실행됨');
